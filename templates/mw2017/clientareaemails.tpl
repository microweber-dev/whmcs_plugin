<div class="mw-whm clientareaemails">
    ...
    <div class="table-responsive">
        <table id="tableEmailsList" class="table">
            <thead>
            <tr>
            ...
            {foreach from=$emails item=email}
                <tr onclick="popupWindow('viewemail.php?id={$email.id}', 'emailWin', '650', '450')">
                    ...
                    <td>{$email.subject}</td>
                    <td class="text-center"><input type="button" class="cbtn cbtn-alt" value="{$LANG.emailviewmessage}"
                                                   onclick="popupWindow('viewemail.php?id={$email.id}', 'emailWin', '650', '450', 'scrollbars=1,')"/></td>
                </tr>
            {/foreach}
            </tbody>
        </table>
