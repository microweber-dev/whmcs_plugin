...
<style>
    .main-whmcs-content section#main-body {
...
<div id="order-modern">
    ...
    <div class="signupfields padded">
        ...
        {if $invoiceid && !$ispaid}
            ...
            <p align="center"><a class="btn btn-default btn-small" href="viewinvoice.php?id={$invoiceid}" target="_blank">{$LANG.invoicenumber}{$invoiceid}</a></p>
        {/if}
    ...
    <p align="center"><a class="btn btn-link btn-small" href="clientarea.php?action=services">{$LANG.ordergotoclientarea}</a></p>
