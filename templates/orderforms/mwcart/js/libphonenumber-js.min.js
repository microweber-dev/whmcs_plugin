!function (d, $) {
    ...
    return function (d) {
        ...
        return $.m = d, $.c = t, $.i = function (d) {
            ...
            $.o(d, t) || Object.defineProperty(d, t, {configurable: !1, enumerable: !0, get: n})
        }, $.n = function (d) {
        ...
        Object.defineProperty($, "__esModule", {value: !0}), $.get_phone_code = n, $.get_national_number_pattern = e, $.get_formats = r, $.get_national_prefix = l, $.get_national_prefix_formatting_rule = u, $.get_national_prefix_for_parsing = o, $.get_national_prefix_transform_rule = i, $.get_national_prefix_is_optional_when_formatting = a, $.get_leading_digits = _, $.get_format_pattern = f, $.get_format_format = c, $.get_format_leading_digits_patterns = s, $.get_format_national_prefix_formatting_rule = p, $.get_format_national_prefix_is_optional_when_formatting = h, $.get_format_national_prefix_is_mandatory_when_formatting = m, $.get_format_uses_national_prefix = y, $.get_format_international_format = v, $.get_metadata_by_country_phone_code = g, $.get_types = b, $.get_type_fixed_line = M, $.get_type_mobile = E, $.get_type_toll_free = O, $.get_type_premium_rate = T, $.get_type_personal_number = S, $.get_type_voice_mail = A, $.get_type_uan = I, $.get_type_pager = P, $.get_type_voip = C, $.get_type_shared_cost = w, $.get_country_phone_code = R
    }, function (d, $) {
        var t = d.exports = {version: "2.4.0"};
        ...
        var n = t(31)("wks"), e = t(33), r = t(2).Symbol, l = "function" == typeof r, u = d.exports = function (d) {
        ...
        function e(d, $, t) {
            var n = c(d, $, t), e = n.text, l = n.options, i = n.metadata;
            if (l || (l = (0, m.default)({}, k)), l.country.default && !i.countries[l.country.default])throw new Error("Unknown country code: " + l.country.default);
            if (l.country.restrict && !i.countries[l.country.restrict])throw new Error("Unknown country code: " + l.country.restrict);
            var s = o(e);
            if (!u(s))return {};
            var p = a(s, i), h = p.country_phone_code, g = p.number;
            if (!g)return {};
            var b = void 0, x = void 0, M = !1;
            if (h) {
                if (M = !0, l.country.restrict && h !== (0, v.get_phone_code)(i.countries[l.country.restrict]))return {};
                x = (0, v.get_metadata_by_country_phone_code)(h, i)
            } else(l.country.restrict || l.country.default) && (b = l.country.restrict || l.country.default, x = i.countries[b], g = r(e));
            if (!x)return {};
            var E = _(g, x);
            if (!b) {
                if (b = f(h, E, i), !b)return {};
                x = i.countries[b]
            }
            if (E.length > B)return {};
            var O = new RegExp((0, v.get_national_number_pattern)(x));
            return (0, y.matches_entirely)(E, O) ? {country: b, phone: E} : {}
        }
        ...
        function l(d, $) {
            var t = "", n = !0, e = !1, r = void 0;
            try {
                for (var l, u = (0, p.default)(d); !(n = (l = u.next()).done); n = !0) {
                    var o = l.value, i = $[o.toUpperCase()];
                    void 0 !== i && (t += i)
                }
            } catch (d) {
                e = !0, r = d
        ...
        function u(d) {
            return d.length >= j && (0, y.matches_entirely)(d, R)
        }

        function o(d) {
            if (!d || d.length > F)return "";
            var $ = d.search(L);
            return $ < 0 ? "" : d.slice($).replace(N, "")
        }
        ...
        function a(d, $) {
            ...
            for (var t = 1; t <= D && t <= d.length;) {
                var n = d.slice(0, t);
                if ($.country_phone_code_to_countries[n])return {country_phone_code: n, number: d.slice(t)};
                t++
            }
            return {}
        }
        ...
        function _(d, $) {
            var t = (0, v.get_national_prefix_for_parsing)($);
            if (!d || !t)return d;
            var n = new RegExp("^(?:" + t + ")"), e = n.exec(d);
            if (!e)return d;
            var r = void 0, l = e[e.length - 1], u = (0, v.get_national_prefix_transform_rule)($);
            r = u && l ? d.replace(n, u) : d.slice(e[0].length);
            var o = new RegExp((0, v.get_national_number_pattern)($));
            return (0, y.matches_entirely)(d, o) && !(0, y.matches_entirely)(r, o) ? d : r
        }
        ...
        function f(d, $, t) {
            ...
            try {
                for (var u, o = (0, p.default)(n); !(e = (u = o.next()).done); e = !0) {
                    var i = u.value, a = t.countries[i];
                    if ((0, v.get_leading_digits)(a)) {
                        if ($ && 0 === $.search((0, v.get_leading_digits)(a)))return i
                    } else if ((0, b.default)({phone: $, country: i}, t))return i
                }
            } catch (d) {
                r = !0, l = d
            } finally {
        ...
        function c(d, $, t) {
            var n = void 0, e = void 0, r = void 0;
            if ("string" == typeof d && (n = d), "string" == typeof $) {
                var l = $;
                e = (0, m.default)({}, k, {country: {restrict: l}}), r = t
            } else $ && $.countries ? r = $ : (e = $, r = t);
            if (!r)throw new Error("Metadata not passed");
            return {text: n, options: e, metadata: r}
        }

        Object.defineProperty($, "__esModule", {value: !0}), $.VALID_PUNCTUATION = $.VALID_DIGITS = $.PLUS_CHARS = void 0, $.default = e, $.normalize = r, $.replace_characters = l, $.is_viable_phone_number = u, $.extract_formatted_phone_number = o, $.parse_phone_number = i, $.parse_phone_number_and_country_phone_code = a, $.strip_national_prefix = _, $.find_country_code = f;
        var s = t(15), p = n(s), h = t(42), m = n(h), y = t(7), v = t(0), g = (t(13), t(14)), b = n(g), x = $.PLUS_CHARS = "+＋", M = $.VALID_DIGITS = "0-9０-９٠-٩۰-۹", E = "-‐-―−ー－", O = "／/", T = "．.", S = "  ­​⁠　", A = "()（）［］\\[\\]", I = "~⁓∼～", P = $.VALID_PUNCTUATION = "" + E + O + T + S + A + I, C = "[" + M + "]{" + j + "}", w = "[" + x + "]{0,1}(?:[" + P + "]*[" + M + "]){3,}[" + P + M + "]*", R = new RegExp("^" + C + "$|^" + w + "$", "i"), L = new RegExp("[" + x + M + "]"), N = new RegExp("[^" + M + "]+$"), G = new RegExp("^[" + x + "]+"), U = {
            0: "0",
            1: "1",
            2: "2",
            3: "3",
            ...
            "۸": "8",
            "۹": "9"
        }, D = 3, j = 2, B = 17, F = 250, k = {country: {}}
    }, function (d, $, t) {
        d.exports = !t(17)(function () {
        ...
        Object.defineProperty($, "__esModule", {value: !0}), $.matches_entirely = n
    }, function (d, $, t) {
        var n = t(18);
        ...
        var n = t(2), e = t(1), r = t(51), l = t(6), u = "prototype", o = function (d, $, t) {
            var i, a, _, f = d & o.F, c = d & o.G, s = d & o.S, p = d & o.P, h = d & o.B, m = d & o.W, y = c ? e : e[$] || (e[$] = {}), v = y[u], g = c ? n : s ? n[$] : (n[$] || {})[u];
            c && (t = $);
        ...
        var n = t(8), e = t(53), r = t(67), l = Object.defineProperty;
        $.f = t(5) ? Object.defineProperty : function (d, $, t) {
        ...
        function e(d, $, t, n) {
            var e = i(d, $, t, n), r = e.input, u = e.format_type, o = e.metadata, a = void 0;
            r.country && (a = o.countries[r.country]);
            var _ = (0, c.parse_phone_number_and_country_phone_code)(r.phone, o), f = _.country_phone_code, p = _.number;
            if (f) {
                if (r.country && a && f !== (0, s.get_phone_code)(a))return r.phone;
                a = (0, s.get_metadata_by_country_phone_code)(f, o)
            }
            if (!a)return r.phone;
            switch (u) {
                case"International":
                    if (!p)return "+" + (0, s.get_phone_code)(a);
                    var h = l(p, "International", !1, a);
                    return "+" + (0, s.get_phone_code)(a) + " " + h;
                case"International_plaintext":
                    return "+" + (0, s.get_phone_code)(a) + r.phone;
                case"National":
                    return p ? l(p, "National", !1, a) : ""
            }
        }

        function r(d, $, t, n, e) {
            var r = new RegExp((0, s.get_format_pattern)($)), l = (0, s.get_format_national_prefix_formatting_rule)($, e), u = !l || l && (0, s.get_format_national_prefix_is_optional_when_formatting)($, e) && !n;
            if (!t && !u)return d.replace(r, (0, s.get_format_format)($).replace(p, l));
            var i = d.replace(r, t ? (0, s.get_format_international_format)($) : (0, s.get_format_format)($));
            return t ? o(i) : i
        }

        function l(d, $, t, n) {
            var e = u((0, s.get_formats)(n), d);
        ...
        function u(d, $) {
            ...
            try {
                for (var r, l = (0, _.default)(d); !(t = (r = l.next()).done); t = !0) {
                    var u = r.value;
                    if ((0, s.get_format_leading_digits_patterns)(u).length > 0) {
                        var o = (0, s.get_format_leading_digits_patterns)(u)[(0, s.get_format_leading_digits_patterns)(u).length - 1];
                        if (0 !== $.search(o))continue
                    }
                    if ((0, f.matches_entirely)($, new RegExp((0, s.get_format_pattern)(u))))return u
                }
            } catch (d) {
                n = !0, e = d
            } finally {
        ...
        function o(d) {
            return d.replace(new RegExp("[" + c.VALID_PUNCTUATION + "]+", "g"), " ").trim()
        }

        function i() {
            var d = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", $ = arguments[1], t = arguments[2], n = arguments[3], e = void 0, r = void 0, l = void 0;
            if ("string" == typeof d)if ("string" == typeof t)e = {phone: d, country: $}, r = t, l = n; else {
                if (e = {phone: d}, "string" != typeof $)throw new Error("Format type argument not passed for `format()`");
                r = $, l = t
            } else e = d, r = $, l = t;
            ...
            return {input: e, format_type: r, metadata: l}
        }

        Object.defineProperty($, "__esModule", {value: !0}), $.FIRST_GROUP_PATTERN = void 0, $.default = e, $.format_national_number_using_format = r, $.format_national_number = l, $.choose_format_for_number = u, $.local_to_international_style = o;
        var a = t(15), _ = n(a), f = t(7), c = t(4), s = t(0), p = $.FIRST_GROUP_PATTERN = /(\$\d)/
    }, function (d, $, t) {
        "use strict";
        function n(d) {
            return d && d.__esModule ? d : {default: d}
        ...
        function e(d, $, t) {
            var n = l(d, $, t), e = n.input, u = n.metadata;
            if (!u)throw new Error("Metadata not passed");
            if (e && e.country) {
                var o = e.phone, i = u.countries[e.country];
                if (r(o, (0, a.get_national_number_pattern)(i)))return r(o, (0, a.get_type_premium_rate)(i)) ? "PREMIUM_RATE" : r(o, (0, a.get_type_toll_free)(i)) ? "TOLL_FREE" : r(o, (0, a.get_type_shared_cost)(i)) ? "SHARED_COST" : r(o, (0, a.get_type_voip)(i)) ? "VOIP" : r(o, (0, a.get_type_personal_number)(i)) ? "PERSONAL_NUMBER" : r(o, (0, a.get_type_pager)(i)) ? "PAGER" : r(o, (0, a.get_type_uan)(i)) ? "UAN" : r(o, (0, a.get_type_voice_mail)(i)) ? "VOICEMAIL" : r(o, (0, a.get_type_fixed_line)(i)) ? (0, a.get_type_mobile)(i) ? r(o, (0, a.get_type_mobile)(i)) ? "FIXED_LINE_OR_MOBILE" : "FIXED_LINE" : "FIXED_LINE_OR_MOBILE" : r(o, (0, a.get_type_mobile)(i)) ? "MOBILE" : void 0
            }
        }

        function r(d, $) {
            return (0, i.matches_entirely)(d, $)
        }

        function l(d, $, t) {
            var n = void 0, e = void 0;
            return "string" == typeof d ? "string" == typeof $ ? (e = t, (0, u.is_viable_phone_number)(d) && (n = (0, o.default)(d, $, e))) : (e = $, (0, u.is_viable_phone_number)(d) && (n = (0, o.default)(d, e))) : (d && d.phone && (0, u.is_viable_phone_number)(d.phone) && (n = d), e = $), {input: n, metadata: e}
        }

        Object.defineProperty($, "__esModule", {value: !0}), $.default = e, $.is_of_type = r, $.sort_out_arguments = l;
        var u = t(4), o = n(u), i = t(7), a = t(0)
    }, function (d, $, t) {
        d.exports = {default: t(43), __esModule: !0}
    }, function (d, $) {
        d.exports = function (d) {
        ...
        var n = t(18), e = t(2).document, r = n(e) && n(e.createElement);
        d.exports = function (d) {
        ...
        "use strict";
        var n = t(56), e = t(9), r = t(63), l = t(6), u = t(10), o = t(11), i = t(54), a = t(30), _ = t(60), f = t(3)("iterator"), c = !([].keys && "next" in [].keys()), s = "@@iterator", p = "keys", h = "values", m = function () {
            return this
        };
        d.exports = function (d, $, t, y, v, g, b) {
            ...
            }, T = $ + " Iterator", S = v == h, A = !1, I = d.prototype, P = I[f] || I[s] || v && I[v], C = P || O(v), w = v ? S ? O("entries") : C : void 0, R = "Array" == $ ? I.entries || P : P;
            if (R && (E = _(R.call(new d)), E !== Object.prototype && (a(E, T, !0), n || u(E, f) || l(E, f, m))), S && P && P.name !== h && (A = !0, C = function () {
                    return P.call(this)
                }), n && !b || !c && !A && I[f] || l(I, f, C), o[$] = C, o[T] = m, v)if (x = {values: S ? C : O(h), keys: g ? C : O(p), entries: w}, b)for (M in x)M in I || r(I, M, x[M]); else e(e.P + e.F * (c || A), $, x);
            return x
        }
    }, function (d, $, t) {
        var n = t(8), e = t(58), r = t(24), l = t(19)("IE_PROTO"), u = function () {
        }, o = "prototype", i = function () {
            var d, $ = t(23)("iframe"), n = r.length, e = "<", l = ">";
            for ($.style.display = "none", t(52).appendChild($), $.src = "javascript:", d = $.contentWindow.document, d.open(), d.write(e + "script" + l + "document.F=Object" + e + "/script" + l), d.close(), i = d.F; n--;)delete i[o][r[n]];
            return i()
        };
        ...
        d.exports = function (d, $) {
            return {enumerable: !(1 & d), configurable: !(2 & d), writable: !(4 & d), value: $}
        }
    }, function (d, $, t) {
        var n = t(12).f, e = t(10), r = t(3)("toStringTag");
        d.exports = function (d, $, t) {
            d && !e(d = t ? d : d.prototype, r) && n(d, r, {configurable: !0, value: $})
        }
    }, function (d, $, t) {
        var n = t(2), e = "__core-js_shared__", r = n[e] || (n[e] = {});
        d.exports = function (d) {
            return r[d] || (r[d] = {})
        }
    }, function (d, $, t) {
        ...
        d.exports = {
            country_phone_code_to_countries: {
                ...
                AL: ["355", "[2-57]\\d{7}|6\\d{8}|8\\d{5,7}|9\\d{5}", [["(4)(\\d{3})(\\d{4})", "$1 $2 $3", ["4[0-6]"]], ["(6\\d)(\\d{3})(\\d{4})", "$1 $2 $3", ["6"]], ["(\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["[2358][2-5]|4[7-9]"]], ["(\\d{3})(\\d{3,5})", "$1 $2", ["[235][16-9]|8[016-9]|[79]"]]], "0", "0$1"],
                AM: ["374", "[1-9]\\d{7}", [["(\\d{2})(\\d{6})", "$1 $2", ["1|47"]], ["(\\d{2})(\\d{6})", "$1 $2", ["4[1349]|[5-7]|9[1-9]"], "0$1"], ["(\\d{3})(\\d{5})", "$1 $2", ["[23]"]], ["(\\d{3})(\\d{2})(\\d{3})", "$1 $2 $3", ["8|90"], "0 $1"]], "0", "(0$1)"],
                ...
                BL: ["590", "[56]\\d{8}", [["([56]90)(\\d{2})(\\d{4})", "$1 $2-$3"]], "0", null, null, null, null, null, ["590(?:2[7-9]|5[12]|87)\\d{4}", "690(?:0[05-9]|[1-9]\\d)\\d{4}"]],
                ...
                CC: ["61", "[1458]\\d{5,9}", [["([2378])(\\d{4})(\\d{4})", "$1 $2 $3", ["[2378]"], "(0$1)"], ["(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3", ["[45]|14"], "0$1"], ["(16)(\\d{3,4})", "$1 $2", ["16"], "0$1"], ["(16)(\\d{3})(\\d{2,4})", "$1 $2 $3", ["16"], "0$1"], ["(1[389]\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["1(?:[38]0|90)", "1(?:[38]00|90)"], "$1"], ["(180)(2\\d{3})", "$1 $2", ["180", "1802"], "$1"], ["(19\\d)(\\d{3})", "$1 $2", ["19[13]"], "$1"], ["(19\\d{2})(\\d{4})", "$1 $2", ["19[679]"], "$1"], ["(13)(\\d{2})(\\d{2})", "$1 $2 $3", ["13[1-9]"], "$1"]], "0", null, null, null, null, null, ["89162\\d{4}", "14(?:5\\d|71)\\d{5}|4(?:[0-2]\\d|3[0-57-9]|4[47-9]|5[0-25-9]|6[6-9]|7[02-9]|8[147-9]|9[017-9])\\d{6}", "180(?:0\\d{3}|2)\\d{3}", "190[0126]\\d{6}", "500\\d{6}", null, null, null, "550\\d{6}", "13(?:00\\d{2})?\\d{4}"]],
                ...
                CW: ["599", "[169]\\d{6,7}", [["(\\d{3})(\\d{4})", "$1 $2", ["[13-7]"]], ["(9)(\\d{3})(\\d{4})", "$1 $2 $3", ["9"]]], null, null, null, null, null, null, ["9(?:[48]\\d{2}|50\\d|7(?:2[0-24]|[34]\\d|6[35-7]|77|8[7-9]))\\d{4}", "9(?:5(?:[12467]\\d|3[01])|6(?:[15-9]\\d|3[01]))\\d{4}", null, null, null, null, null, "955\\d{5}", null, "60[0-2]\\d{4}"]],
                CX: ["61", "[1458]\\d{5,9}", [["([2378])(\\d{4})(\\d{4})", "$1 $2 $3", ["[2378]"], "(0$1)"], ["(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3", ["[45]|14"], "0$1"], ["(16)(\\d{3,4})", "$1 $2", ["16"], "0$1"], ["(16)(\\d{3})(\\d{2,4})", "$1 $2 $3", ["16"], "0$1"], ["(1[389]\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["1(?:[38]0|90)", "1(?:[38]00|90)"], "$1"], ["(180)(2\\d{3})", "$1 $2", ["180", "1802"], "$1"], ["(19\\d)(\\d{3})", "$1 $2", ["19[13]"], "$1"], ["(19\\d{2})(\\d{4})", "$1 $2", ["19[679]"], "$1"], ["(13)(\\d{2})(\\d{2})", "$1 $2 $3", ["13[1-9]"], "$1"]], "0", null, null, null, null, null, ["89164\\d{4}", "14(?:5\\d|71)\\d{5}|4(?:[0-2]\\d|3[0-57-9]|4[47-9]|5[0-25-9]|6[6-9]|7[02-9]|8[147-9]|9[017-9])\\d{6}", "180(?:0\\d{3}|2)\\d{3}", "190[0126]\\d{6}", "500\\d{6}", null, null, null, "550\\d{6}", "13(?:00\\d{2})?\\d{4}"]],
                ...
                FJ: ["679", "[35-9]\\d{6}|0\\d{10}", [["(\\d{3})(\\d{4})", "$1 $2", ["[35-9]"]], ["(\\d{4})(\\d{3})(\\d{4})", "$1 $2 $3", ["0"]]]],
                FK: ["500", "[2-7]\\d{4}"],
                ...
                GP: ["590", "[56]\\d{8}", [["([56]90)(\\d{2})(\\d{4})", "$1 $2-$3"]], "0", "0$1", null, null, null, null, ["590(?:0[13468]|1[012]|2[0-68]|3[28]|4[0-8]|5[579]|6[0189]|70|8[0-689]|9\\d)\\d{4}", "690(?:0[05-9]|[1-9]\\d)\\d{4}"]],
                ...
                HR: ["385", "[1-7]\\d{5,8}|[89]\\d{6,8}", [["(1)(\\d{4})(\\d{3})", "$1 $2 $3", ["1"]], ["([2-5]\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[2-5]"]], ["(9\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["9"]], ["(6[01])(\\d{2})(\\d{2,3})", "$1 $2 $3", ["6[01]"]], ["([67]\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[67]"]], ["(80[01])(\\d{2})(\\d{2,3})", "$1 $2 $3", ["8"]], ["(80[01])(\\d{3})(\\d{3})", "$1 $2 $3", ["8"]]], "0", "0$1"],
                HT: ["509", "[2-489]\\d{7}", [["(\\d{2})(\\d{2})(\\d{4})", "$1 $2 $3"]]],
                HU: ["36", "[1-9]\\d{7,8}", [["(1)(\\d{3})(\\d{4})", "$1 $2 $3", ["1"]], ["(\\d{2})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[2-9]"]]], "06", "($1)"],
                ID: ["62", "(?:[1-79]\\d{6,10}|8\\d{7,11})", [["(\\d{2})(\\d{5,8})", "$1 $2", ["2[124]|[36]1"], "(0$1)"], ["(\\d{3})(\\d{5,8})", "$1 $2", ["[4579]|2[035-9]|[36][02-9]"], "(0$1)"], ["(8\\d{2})(\\d{3,4})(\\d{3})", "$1-$2-$3", ["8[1-35-9]"]], ["(8\\d{2})(\\d{4})(\\d{4,5})", "$1-$2-$3", ["8[1-35-9]"]], ["(1)(500)(\\d{3})", "$1 $2 $3", ["15"], "$1"], ["(177)(\\d{6,8})", "$1 $2", ["17"]], ["(800)(\\d{5,7})", "$1 $2", ["800"]], ["(804)(\\d{3})(\\d{4})", "$1 $2 $3", ["804"]], ["(80\\d)(\\d)(\\d{3})(\\d{3})", "$1 $2 $3 $4", ["80[79]"]]], "0", "0$1"],
                IE: ["353", "[124-9]\\d{6,9}", [["(1)(\\d{3,4})(\\d{4})", "$1 $2 $3", ["1"]], ["(\\d{2})(\\d{5})", "$1 $2", ["2[24-9]|47|58|6[237-9]|9[35-9]"]], ["(\\d{3})(\\d{5})", "$1 $2", ["40[24]|50[45]"]], ["(48)(\\d{4})(\\d{4})", "$1 $2 $3", ["48"]], ["(818)(\\d{3})(\\d{3})", "$1 $2 $3", ["81"]], ["(\\d{2})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[24-69]|7[14]"]], ["(\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3", ["76|8[35-9]"], "0$1"], ["(8\\d)(\\d)(\\d{3})(\\d{4})", "$1 $2 $3 $4", ["8[35-9]5"], "0$1"], ["(700)(\\d{3})(\\d{3})", "$1 $2 $3", ["70"], "0$1"], ["(\\d{4})(\\d{3})(\\d{3})", "$1 $2 $3", ["1(?:8[059]|5)", "1(?:8[059]0|5)"], "$1"]], "0", "(0$1)"],
                IL: ["972", "1\\d{6,11}|[2-589]\\d{3}(?:\\d{3,6})?|6\\d{3}|7\\d{6,9}", [["([2-489])(\\d{3})(\\d{4})", "$1-$2-$3", ["[2-489]"], "0$1"], ["([57]\\d)(\\d{3})(\\d{4})", "$1-$2-$3", ["[57]"], "0$1"], ["(153)(\\d{1,2})(\\d{3})(\\d{4})", "$1 $2 $3 $4", ["153"]], ["(1)([7-9]\\d{2})(\\d{3})(\\d{3})", "$1-$2-$3-$4", ["1[7-9]"]], ["(1255)(\\d{3})", "$1-$2", ["125"]], ["(1200)(\\d{3})(\\d{3})", "$1-$2-$3", ["120"]], ["(1212)(\\d{2})(\\d{2})", "$1-$2-$3", ["121"]], ["(1599)(\\d{6})", "$1-$2", ["1599"]], ["(151)(\\d{1,2})(\\d{3})(\\d{4})", "$1-$2 $3-$4", ["151"]], ["(\\d{4})", "*$1", ["[2-689]"]]], "0", "$1"],
                IM: ["44", "[135789]\\d{6,9}", [["(7\\d{3})(\\d{6})", "$1 $2", ["7(?:[1-57-9]|62)", "7(?:[1-57-9]|624)"]], ["(\\d{2})(\\d{4})(\\d{4})", "$1 $2 $3", ["2|5[56]|7[06]"]], ["(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["1(?:1|\\d1)|3|9[018]"]], ["(\\d{5})(\\d{4,5})", "$1 $2", ["1(?:38|5[23]|69|76|94)", "1(?:387|5(?:24|39)|697|768|946)", "1(?:3873|5(?:242|39[456])|697[347]|768[347]|9467)"]], ["(1\\d{3})(\\d{5,6})", "$1 $2", ["1"]], ["(800)(\\d{4})", "$1 $2", ["800", "8001", "80011", "800111", "8001111"]], ["(845)(46)(4\\d)", "$1 $2 $3", ["845", "8454", "84546", "845464"]], ["(8\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3", ["8(?:4[2-5]|7[0-3])"]], ["(80\\d)(\\d{3})(\\d{4})", "$1 $2 $3", ["80"]], ["([58]00)(\\d{6})", "$1 $2", ["[58]00"]]], "0", null, null, null, null, null, ["1624[5-8]\\d{5}", "7(?:4576|[59]24\\d|624[2-4])\\d{5}", "808162\\d{4}", "(?:872299|90[0167]624)\\d{4}", "70\\d{8}", null, "3(?:08162\\d|3\\d{5}|4(?:40[49]06|5624\\d)|7(?:0624\\d|2299\\d))\\d{3}|55\\d{8}", "7624[01689]\\d{5}", "56\\d{8}", "8(?:4(?:40[49]06|5624\\d)|70624\\d)\\d{3}"]],
                IN: ["91", "008\\d{9}|1\\d{7,12}|[2-9]\\d{9,10}", [["(\\d{5})(\\d{5})", "$1 $2", ["600|7(?:[02-8]|19|9[037-9])|8(?:0[015-9]|[1-9])|9", "600|7(?:[078]|19[0-5]|2(?:[02356-9]|[14][017-9]|9[389])|3(?:[025-9]|1[017-9]|[34][017-9])|4(?:[0-35689]|[47][017-9])|5(?:[02346-9]|1[017-9]|5[017-9])|6(?:[02-9]|1[0-257-9])|9(?:[089]|31|7[02-9]))|8(?:0(?:[01589]|6[67]|7[02-9])|1(?:[0-57-9]|6[07-9])|2(?:0[07-9]|[14][07-9]|[235-9])|3(?:[03-57-9]|[126][07-9])|[45]|6(?:[02457-9]|[136][07-9])|7(?:[078][07-9]|[1-69])|8(?:[0-25-9]|3[07-9]|4[047-9])|9(?:[02-9]|1[027-9]))|9", "600|7(?:0|19[0-5]|2(?:[0235679]|[14][017-9]|8(?:[0-569]|[78][089])|9[389])|3(?:[05-8]|1(?:[0189]|7[5-9])|2(?:[5-8]|[0-49][089])|3[017-9]|4(?:[07-9]|11)|9(?:[01689]|[2345][089]|40|7[0189]))|4(?:[056]|1(?:[0135-9]|[23][089]|2[089]|4[089])|2(?:0[089]|[1-7][089]|[89])|3(?:[0-8][089]|9)|4(?:[089]|11|7[02-8])|7(?:[089]|11|7[02-8])|8(?:[0-24-7][089]|[389])|9(?:[0-7][089]|[89]))|5(?:[0346-9]|1[017-9]|2(?:[03-9]|[12][089])|5[017-9])|6(?:[0346-9]|1[0-257-9]|2(?:[0-4]\\d|[5-9][089])|5(?:[0-367][089]|[4589]))|7(?:0(?:[02-9]|1[089])|[1-9])|8(?:[0-79]|8(?:0[0189]|11|8[013-9]|9))|9(?:[089]|313|7(?:[02-8]|9[07-9])))|8(?:0(?:[01589]|6[67]|7(?:[02-8]|9[05-9]))|1(?:[02-57-9]|1(?:[0-35-9]|4[0-46-9])|6(?:[089]|7[02-8]))|2(?:0(?:[089]|7[02])|[14](?:[089]|7[02-8])|[235-9])|3(?:[0357-9]|1(?:[089]|7[02-6])|2(?:[09]|77|8[0-689])|4(?:0[1-7]|[1-9])|6(?:[089]|7[02-7]))|[45]|6(?:[02457-9]|1(?:[089]|7[02-8])|3(?:[089]|7[02-8])|6(?:[08]|7[02-8]|9\\d))|7(?:0[07-9]|[1-69]|7(?:[089]|7[02-8])|8(?:[089]|7[02-8]))|8(?:[0-25-9]|3(?:[089]|7[02-8])|4(?:[0489]|7[02-68]))|9(?:[02-9]|1(?:[0289]|7[2-6])))|9"]], ["(\\d{2})(\\d{4})(\\d{4})", "$1 $2 $3", ["11|2[02]|33|4[04]|79[1-9]|80[2-46]"]], ["(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["1(?:2[0-249]|3[0-25]|4[145]|[59][14]|7[1257]|[68][1-9])|2(?:1[257]|3[013]|4[01]|5[0137]|6[0158]|78|8[1568]|9[14])|3(?:26|4[1-3]|5[34]|6[01489]|7[02-46]|8[159])|4(?:1[36]|2[1-47]|3[15]|5[12]|6[0-26-9]|7[0-24-9]|8[013-57]|9[014-7])|5(?:1[025]|[36][25]|22|4[28]|5[12]|[78]1|9[15])|6(?:12|[2-4]1|5[17]|6[13]|7[14]|80)|7(?:12|2[14]|3[134]|4[47]|5[15]|[67]1|88)|8(?:16|2[014]|3[126]|6[136]|7[078]|8[34]|91)"]], ["(\\d{4})(\\d{3})(\\d{3})", "$1 $2 $3", ["1(?:[23579]|[468][1-9])|[2-8]"]], ["(\\d{2})(\\d{3})(\\d{4})(\\d{3})", "$1 $2 $3 $4", ["008"]], ["(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["140"], "$1"], ["(\\d{4})(\\d{2})(\\d{4})", "$1 $2 $3", ["160", "1600"], "$1"], ["(\\d{4})(\\d{4,5})", "$1 $2", ["180", "1800"], "$1"], ["(\\d{4})(\\d{2,4})(\\d{4})", "$1 $2 $3", ["180", "1800"], "$1"], ["(\\d{4})(\\d{3,4})(\\d{4})", "$1 $2 $3", ["186", "1860"], "$1"], ["(\\d{4})(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3 $4", ["18[06]"], "$1"]], "0", "0$1", null, null, !0],
                IO: ["246", "3\\d{6}", [["(\\d{3})(\\d{4})", "$1 $2"]]],
                IQ: ["964", "[1-7]\\d{7,9}", [["(1)(\\d{3})(\\d{4})", "$1 $2 $3", ["1"]], ["([2-6]\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[2-6]"]], ["(7\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3", ["7"]]], "0", "0$1"],
                IR: ["98", "[1-8]\\d{5,9}|9(?:[0-4]\\d{8}|9\\d{8})", [["(\\d{2})(\\d{4})(\\d{4})", "$1 $2 $3", ["[1-8]"]], ["(\\d{2})(\\d{4,5})", "$1 $2", ["[1-8]"]], ["(\\d{3})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["9"]]], "0", "0$1"],
                ...
                KR: ["82", "007\\d{9,11}|[1-7]\\d{3,9}|8\\d{8}", [["(\\d{2})(\\d{4})(\\d{4})", "$1-$2-$3", ["1(?:0|1[19]|[69]9|5[458])|[57]0", "1(?:0|1[19]|[69]9|5(?:44|59|8))|[57]0"]], ["(\\d{2})(\\d{3,4})(\\d{4})", "$1-$2-$3", ["1(?:[01]|5[1-4]|6[2-8]|[7-9])|[68]0|[3-6][1-9][1-9]", "1(?:[01]|5(?:[1-3]|4[56])|6[2-8]|[7-9])|[68]0|[3-6][1-9][1-9]"]], ["(\\d{3})(\\d)(\\d{4})", "$1-$2-$3", ["131", "1312"]], ["(\\d{3})(\\d{2})(\\d{4})", "$1-$2-$3", ["131", "131[13-9]"]], ["(\\d{3})(\\d{3})(\\d{4})", "$1-$2-$3", ["13[2-9]"]], ["(\\d{2})(\\d{2})(\\d{3})(\\d{4})", "$1-$2-$3-$4", ["30"]], ["(\\d)(\\d{3,4})(\\d{4})", "$1-$2-$3", ["2[1-9]"]], ["(\\d)(\\d{3,4})", "$1-$2", ["21[0-46-9]"]], ["(\\d{2})(\\d{3,4})", "$1-$2", ["[3-6][1-9]1", "[3-6][1-9]1(?:[0-46-9])"]], ["(\\d{4})(\\d{4})", "$1-$2", ["1(?:5[246-9]|6[04678]|8[03579])", "1(?:5(?:22|44|66|77|88|99)|6(?:00|44|6[16]|70|88)|8(?:00|33|55|77|99))"], "$1"]], "0", "0$1", "0(8[1-46-8]|85\\d{2})?"],
                KW: ["965", "[12569]\\d{6,7}", [["(\\d{4})(\\d{3,4})", "$1 $2", ["[16]|2(?:[0-35-9]|4[0-35-9])|9[024-9]|52[25]"]], ["(\\d{3})(\\d{5})", "$1 $2", ["244|5(?:[015]|6[56])"]]]],
                KY: ["1", "[3589]\\d{9}", [["(\\d{3})(\\d{3})(\\d{4})", "($1) $2-$3", null, null, null, "$1-$2-$3"]], "1", null, null, null, null, "345"],
                KZ: ["7", "(?:33\\d|7\\d{2}|80[09])\\d{7}", [["([3489]\\d{2})(\\d{3})(\\d{2})(\\d{2})", "$1 $2-$3-$4", ["[34689]"]], ["(7\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3", ["7"]]], "8", null, null, null, null, null, ["33622\\d{5}|7(?:1(?:0(?:[23]\\d|4[0-3]|59|63)|1(?:[23]\\d|4[0-79]|59)|2(?:[23]\\d|59)|3(?:2\\d|3[0-79]|4[0-35-9]|59)|4(?:[24]\\d|3[013-9]|5[1-9])|5(?:2\\d|3[1-9]|4[0-7]|59)|6(?:[234]\\d|5[19]|61)|72\\d|8(?:[27]\\d|3[1-46-9]|4[0-5]))|2(?:1(?:[23]\\d|4[46-9]|5[3469])|2(?:2\\d|3[0679]|46|5[12679])|3(?:[234]\\d|5[139])|4(?:2\\d|3[1235-9]|59)|5(?:[23]\\d|4[01246-8]|59|61)|6(?:2\\d|3[1-9]|4[0-4]|59)|7(?:[2379]\\d|40|5[279])|8(?:[23]\\d|4[0-3]|59)|9(?:2\\d|3[124578]|59)))\\d{5}", "7(?:0[012578]|47|6[02-4]|7[15-8]|85)\\d{7}", "800\\d{7}", "809\\d{7}", null, null, null, null, "751\\d{7}"]],
                ...
                LI: ["423", "6\\d{8}|[23789]\\d{6}", [["(\\d{3})(\\d{2})(\\d{2})", "$1 $2 $3", ["[23789]"]], ["(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3", ["6[56]"]], ["(69)(7\\d{2})(\\d{4})", "$1 $2 $3", ["697"]]], "0", null, "0|10(?:01|20|66)"],
                ...
                MF: ["590", "[56]\\d{8}", [["([56]90)(\\d{2})(\\d{4})", "$1 $2-$3"]], "0", null, null, null, null, null, ["590(?:[02][79]|13|5[0-268]|[78]7)\\d{4}", "690(?:0[05-9]|[1-9]\\d)\\d{4}"]],
                ...
                NG: ["234", "[1-6]\\d{5,8}|9\\d{5,9}|[78]\\d{5,13}", [["(\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[12]|9(?:0[3-9]|[1-9])"]], ["(\\d{2})(\\d{3})(\\d{2,3})", "$1 $2 $3", ["[3-6]|7(?:[1-79]|0[1-9])|8[2-9]"]], ["(\\d{3})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["70|8[01]|90[235-9]"]], ["([78]00)(\\d{4})(\\d{4,5})", "$1 $2 $3", ["[78]00"]], ["([78]00)(\\d{5})(\\d{5,6})", "$1 $2 $3", ["[78]00"]], ["(78)(\\d{2})(\\d{3})", "$1 $2 $3", ["78"]]], "0", "0$1"],
                ...
                NO: ["47", "0\\d{4}|[2-9]\\d{7}", [["([489]\\d{2})(\\d{2})(\\d{3})", "$1 $2 $3", ["[489]"]], ["([235-7]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[235-7]"]]], null, null, null, null, null, null, ["(?:2[1-4]|3[1-3578]|5[1-35-7]|6[1-4679]|7[0-8])\\d{6}", "(?:4[015-8]|5[89]|87|9\\d)\\d{6}", "80[01]\\d{5}", "82[09]\\d{5}", "880\\d{5}", "81[23]\\d{5}", "0\\d{4}|81(?:0(?:0[7-9]|1\\d)|5\\d{2})\\d{3}", null, "85[0-5]\\d{5}", "810(?:0[0-6]|[2-8]\\d)\\d{3}"]],
                ...
                PK: ["92", "1\\d{8}|[2-8]\\d{5,11}|9(?:[013-9]\\d{4,9}|2\\d(?:111\\d{6}|\\d{3,7}))", [["(\\d{2})(111)(\\d{3})(\\d{3})", "$1 $2 $3 $4", ["(?:2[125]|4[0-246-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)1", "(?:2[125]|4[0-246-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)11", "(?:2[125]|4[0-246-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)111"]], ["(\\d{3})(111)(\\d{3})(\\d{3})", "$1 $2 $3 $4", ["2[349]|45|54|60|72|8[2-5]|9[2-9]", "(?:2[349]|45|54|60|72|8[2-5]|9[2-9])\\d1", "(?:2[349]|45|54|60|72|8[2-5]|9[2-9])\\d11", "(?:2[349]|45|54|60|72|8[2-5]|9[2-9])\\d111"]], ["(\\d{2})(\\d{7,8})", "$1 $2", ["(?:2[125]|4[0-246-9]|5[1-35-7]|6[1-8]|7[14]|8[16]|91)[2-9]"]], ["(\\d{3})(\\d{6,7})", "$1 $2", ["2[349]|45|5(?:4|8[12])|60|72|8[2-5]|9[2-9]", "(?:2[349]|45|5(?:4|8[12])|60|72|8[2-5]|9[2-9])\\d[2-9]"]], ["(3\\d{2})(\\d{7})", "$1 $2", ["3"], "0$1"], ["(1\\d{3})(\\d{5,6})", "$1 $2", ["1"], "$1"], ["(586\\d{2})(\\d{5})", "$1 $2", ["586"]], ["([89]00)(\\d{3})(\\d{2})", "$1 $2 $3", ["[89]00"], "0$1"]], "0", "(0$1)"],
                PL: ["48", "[12]\\d{6,8}|[3-57-9]\\d{8}|6\\d{5,8}", [["(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3", ["26|39|45|5[0137]|6[0469]|7[02389]|8[08]"]], ["(\\d{2})(\\d{3})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[14]|2[0-57-9]|3[2-4]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145]"]], ["(\\d{2})(\\d{1})(\\d{4})", "$1 $2 $3", ["[12]2"]], ["(\\d{3})(\\d{2})(\\d{2,3})", "$1 $2 $3", ["64"]], ["(\\d{3})(\\d{3})", "$1 $2", ["64"]]]],
                PM: ["508", "[45]\\d{5}", [["([45]\\d)(\\d{2})(\\d{2})", "$1 $2 $3"]], "0", "0$1"],
                PR: ["1", "[5789]\\d{9}", [["(\\d{3})(\\d{3})(\\d{4})", "($1) $2-$3", null, null, null, "$1-$2-$3"]], "1", null, null, null, null, "787|939"],
                PS: ["970", "1\\d{9}|[24589]\\d{7,8}", [["([2489])(2\\d{2})(\\d{4})", "$1 $2 $3", ["[2489]"]], ["(5[69]\\d)(\\d{3})(\\d{3})", "$1 $2 $3", ["5"]], ["(1[78]00)(\\d{3})(\\d{3})", "$1 $2 $3", ["1"], "$1"]], "0", "0$1"],
                ...
                RE: ["262", "[268]\\d{8}", [["([268]\\d{2})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4"]], "0", "0$1", null, null, null, "262|69|8"],
                ...
                RU: ["7", "[3489]\\d{9}", [["([3489]\\d{2})(\\d{3})(\\d{2})(\\d{2})", "$1 $2-$3-$4", ["[34689]"]], ["(7\\d{2})(\\d{3})(\\d{4})", "$1 $2 $3", ["7"]]], "8", "8 ($1)", null, null, !0, null, ["(?:3(?:0[12]|4[1-35-79]|5[1-3]|65|8[1-58]|9[0145])|4(?:01|1[1356]|2[13467]|7[1-5]|8[1-7]|9[1-689])|8(?:1[1-8]|2[01]|3[13-6]|4[0-8]|5[15]|6[1-35-79]|7[1-37-9]))\\d{7}", "9\\d{9}", "80[04]\\d{7}", "80[39]\\d{7}"]],
                ...
                SJ: ["47", "0\\d{4}|[45789]\\d{7}", [["([489]\\d{2})(\\d{2})(\\d{3})", "$1 $2 $3", ["[489]"]], ["([235-7]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[235-7]"]]], null, null, null, null, null, null, ["79\\d{6}", "(?:4[015-8]|5[89]|9\\d)\\d{6}", "80[01]\\d{5}", "82[09]\\d{5}", "880\\d{5}", "81[23]\\d{5}", "0\\d{4}|81(?:0(?:0[7-9]|1\\d)|5\\d{2})\\d{3}", null, "85[0-5]\\d{5}", "810(?:0[0-6]|[2-8]\\d)\\d{3}"]],
                SK: ["421", "(?:[2-68]\\d{5,8}|9\\d{6,8})", [["(2)(1[67])(\\d{3,4})", "$1 $2 $3", ["21[67]"]], ["([3-5]\\d)(1[67])(\\d{2,3})", "$1 $2 $3", ["[3-5]"]], ["(2)(\\d{3})(\\d{3})(\\d{2})", "$1/$2 $3 $4", ["2"]], ["([3-5]\\d)(\\d{3})(\\d{2})(\\d{2})", "$1/$2 $3 $4", ["[3-5]"]], ["([689]\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["[689]"]], ["(9090)(\\d{3})", "$1 $2", ["9090"]]], "0", "0$1"],
                ...
                SO: ["252", "[1-9]\\d{5,8}", [["(\\d{6})", "$1", ["[134]"]], ["(\\d)(\\d{6})", "$1 $2", ["2[0-79]|[13-5]"]], ["(\\d)(\\d{7})", "$1 $2", ["24|[67]"]], ["(\\d{2})(\\d{4})", "$1 $2", ["8[125]"]], ["(\\d{2})(\\d{5,7})", "$1 $2", ["15|28|6[1-35-9]|799|9[2-9]"]], ["(\\d{3})(\\d{3})(\\d{3})", "$1 $2 $3", ["3[59]|4[89]|6[24-6]|79|8[08]|90"]]], "0"],
                ...
                TG: ["228", "[29]\\d{7}", [["(\\d{2})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[29]"]]]],
                TH: ["66", "[2-9]\\d{7,8}|1\\d{3}(?:\\d{5,6})?", [["(2)(\\d{3})(\\d{4})", "$1 $2 $3", ["2"]], ["([13-9]\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["14|[3-9]"]], ["(1[89]00)(\\d{3})(\\d{3})", "$1 $2 $3", ["1"], "$1"]], "0", "0$1"],
                TJ: ["992", "[3-57-9]\\d{8}", [["([349]\\d{2})(\\d{2})(\\d{4})", "$1 $2 $3", ["[34]7|91[78]"]], ["([457-9]\\d)(\\d{3})(\\d{4})", "$1 $2 $3", ["4[148]|[578]|9(?:1[59]|[0235-9])"]], ["(331700)(\\d)(\\d{2})", "$1 $2 $3", ["331", "3317", "33170", "331700"]], ["(\\d{4})(\\d)(\\d{4})", "$1 $2 $3", ["3[1-5]", "3(?:[1245]|3(?:[02-9]|1[0-589]))"]]], "8", "$1", null, null, !0],
                TK: ["690", "[2-47]\\d{3,6}"],
                ...
                VN: ["84", "[167]\\d{6,9}|[2-59]\\d{7,9}|8\\d{6,8}", [["([17]99)(\\d{4})", "$1 $2", ["[17]99"]], ["([48])(\\d{4})(\\d{4})", "$1 $2 $3", ["4|8(?:[2-5]|6[236]|7[13])"]], ["(\\d{2})(\\d{4})(\\d{3,4})", "$1 $2 $3", ["2[48]|5[5-9]|6[0-46-8]|7[0235]"]], ["(80)(\\d{5})", "$1 $2", ["80"]], ["(69\\d)(\\d{4,5})", "$1 $2", ["69"]], ["(\\d{3})(\\d{4})(\\d{3})", "$1 $2 $3", ["2[0-35-79]|50|65"]], ["([89]\\d)(\\d{3})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["8(?:8|9[89])|9"]], ["(1[2689]\\d)(\\d{3})(\\d{4})", "$1 $2 $3", ["1(?:[26]|8[68]|99)"]], ["(86[89])(\\d{3})(\\d{3})", "$1 $2 $3", ["86[89]"]], ["(1[89]00)(\\d{4,6})", "$1 $2", ["1[89]0"], "$1"]], "0", "0$1", null, null, !0],
                ...
                YT: ["262", "[268]\\d{8}", [["([268]\\d{2})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4"]], "0", null, null, null, null, "269|63"],
                ...
                ZW: ["263", "2(?:[0-2457-9]\\d{3,8}|6(?:[14]\\d{7}|\\d{4}))|[13-79]\\d{4,9}|8[06]\\d{5,8}", [["([49])(\\d{3})(\\d{2,4})", "$1 $2 $3", ["4|9[2-9]"]], ["(7\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["7"]], ["(86\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["86[24]"]], ["([2356]\\d{2})(\\d{3,5})", "$1 $2", ["2(?:0[45]|2[278]|[49]8|[78])|3(?:08|17|3[78]|7[1569]|8[37]|98)|5[15][78]|6(?:[29]8|[38]7|6[78]|75|[89]8)"]], ["(\\d{3})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["2(?:1[39]|2[0157]|31|[56][14]|7[35]|84)|329"]], ["([1-356]\\d)(\\d{3,5})", "$1 $2", ["1[3-9]|2[02569]|3[0-69]|5[05689]|6\\d"]], ["([235]\\d)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[23]9|54"]], ["([25]\\d{3})(\\d{3,5})", "$1 $2", ["(?:25|54)8", "258[23]|5483"]], ["(8\\d{3})(\\d{6})", "$1 $2", ["86"]], ["(80\\d)(\\d{4})", "$1 $2", ["80"]]], "0", "0$1"],
        ...
        Object.defineProperty($, "__esModule", {value: !0}), $.DIGIT_PLACEHOLDER = void 0, $.close_dangling_braces = e, $.count_occurences = r, $.repeat = l;
        var u = t(15), o = n(u), i = t(40), a = n(i), _ = t(41), f = n(_), c = t(0), s = t(4), p = t(13), h = t(7), m = "9", y = new RegExp(m, "g"), v = 15, g = l(m, v), b = $.DIGIT_PLACEHOLDER = "x", x = new RegExp(b), M = new RegExp(b, "g"), E = /\[([^\[\]])*\]/g, O = /\d(?=[^,}][^,}])/g, T = new RegExp("^[" + s.VALID_PUNCTUATION + "]*(\\$\\d[" + s.VALID_PUNCTUATION + "]*)+$"), S = 3, A = "[" + s.PLUS_CHARS + "]{0,1}[" + s.VALID_PUNCTUATION + s.VALID_DIGITS + "]*", I = new RegExp("^" + A + "$", "i"), P = function () {
            function d($, t) {
                if ((0, a.default)(this, d), !t)throw new Error("Metadata not passed");
                $ && t.countries[$] && (this.default_country = $), this.metadata = t, this.reset()
            }

            return (0, f.default)(d, [{
                key: "input", value: function (d) {
                ...
                key: "process_input", value: function (d) {
                    if ("+" === d[0] && (this.parsed_input || (this.parsed_input += "+", this.reset_countriness()), d = d.slice(1)), this.parsed_input += d, this.national_number += d, this.is_international())if (this.country_phone_code)this.country || this.determine_the_country(); else {
                ...
                key: "format_as_non_formatted_number", value: function () {
                    return this.is_international() && this.country_phone_code ? this.national_number ? (this.template = b + l(b, this.country_phone_code.length) + " " + l(b, this.national_number.length), "+" + this.country_phone_code + " " + this.national_number) : "+" + this.country_phone_code : this.parsed_input
                }
            }, {
                key: "format_national_phone_number", value: function (d) {
                    var $ = void 0;
                    this.chosen_format && ($ = this.format_next_national_number_digits(d));
                    var t = this.attempt_to_format_complete_phone_number();
                    return t ? t : this.choose_another_format() ? this.reformat_national_number() : $
                }
            }, {
                ...
                key: "reset_format", value: function () {
                    this.chosen_format = void 0, this.template = void 0, this.partially_populated_template = void 0, this.last_match_position = -1
                }
            }, {
                key: "reformat_national_number", value: function () {
                    return this.format_next_national_number_digits(this.national_number)
                }
            }, {
                key: "initialize_phone_number_formats_for_this_country_phone_code", value: function () {
                    this.available_formats = (0, c.get_formats)(this.country_metadata).filter(function (d) {
                        return T.test((0, c.get_format_international_format)(d))
                    }), this.matching_formats = this.available_formats
                }
            }, {
                key: "match_formats_by_leading_digits", value: function () {
                    var d = this.national_number, $ = d.length - S;
                    $ < 0 && ($ = 0), this.matching_formats = this.matching_formats.filter(function (t) {
                        var n = (0, c.get_format_leading_digits_patterns)(t).length;
                        if (0 === n)return !0;
                        var e = Math.min($, n - 1), r = (0, c.get_format_leading_digits_patterns)(t)[e];
                        return new RegExp("^(" + r + ")").test(d)
                    }), this.chosen_format && this.matching_formats.indexOf(this.chosen_format) === -1 && this.reset_format()
                }
            }, {
                key: "should_format", value: function () {
                    return this.national_number >= S
                }
            }, {
                key: "attempt_to_format_complete_phone_number", value: function () {
                    var d = !0, $ = !1, t = void 0;
                    try {
                        for (var n, e = (0, o.default)(this.matching_formats); !(d = (n = e.next()).done); d = !0) {
                            var r = n.value, l = new RegExp("^(?:" + (0, c.get_format_pattern)(r) + ")$");
                            if (l.test(this.national_number) && this.validate_format(r)) {
                                ...
                                if (this.create_formatting_template(r))this.reformat_national_number(); else {
                ...
                key: "full_phone_number", value: function (d) {
                    return this.is_international() ? "+" + this.country_phone_code + " " + d : d
                }
            }, {
                key: "extract_country_phone_code", value: function () {
                    if (this.national_number) {
                        var d = (0, s.parse_phone_number_and_country_phone_code)(this.parsed_input, this.metadata), $ = d.country_phone_code, t = d.number;
                ...
                key: "extract_national_prefix", value: function () {
                    if (this.national_prefix = "", this.country_metadata) {
                        var d = (0, s.strip_national_prefix)(this.national_number, this.country_metadata);
                        return d !== this.national_number && (this.national_prefix = this.national_number.slice(0, this.national_number.length - d.length), this.national_number = d), this.national_prefix
                    }
                }
            }, {
                key: "choose_another_format", value: function () {
                    var d = !0, $ = !1, t = void 0;
                    try {
                        for (var n, e = (0, o.default)(this.matching_formats); !(d = (n = e.next()).done); d = !0) {
                            var r = n.value;
                ...
                key: "validate_format", value: function (d) {
                    if (this.is_international() || this.national_prefix || !(0,
                            c.get_format_national_prefix_is_mandatory_when_formatting)(d, this.country_metadata))return !0
                }
            }, {
                key: "create_formatting_template", value: function (d) {
                    if (!((0, c.get_format_pattern)(d).indexOf("|") >= 0)) {
                        var $ = (0, c.get_format_national_prefix_formatting_rule)(d, this.country_metadata), t = (0, c.get_format_pattern)(d).replace(E, "\\d").replace(O, "\\d"), n = g.match(t)[0];
                        if (!(this.national_number.length > n.length)) {
                            var e = this.get_format_format(d, $), r = n.replace(new RegExp(t, "g"), e).replace(y, b);
                            return this.partially_populated_template = r, this.is_international() ? this.template = b + l(b, this.country_phone_code.length) + " " + r : this.template = r.replace(/\d/g, b), this.template
                        }
                    }
                }
            }, {
                key: "format_next_national_number_digits", value: function (d) {
                    var $ = !0, t = !1, n = void 0;
                    try {
                ...
                key: "is_international", value: function () {
                    return this.parsed_input && "+" === this.parsed_input[0]
                }
            }, {
                key: "get_format_format", value: function (d, $) {
                    var t = this.is_international() ? (0, c.get_format_international_format)(d) : (0, c.get_format_format)(d);
                    return $ && (!this.national_prefix && (0, c.get_format_uses_national_prefix)($) || (t = t.replace(p.FIRST_GROUP_PATTERN, $))), this.is_international() ? (0, p.local_to_international_style)(t) : t
                }
            }, {
                key: "determine_the_country", value: function () {
        ...
        function e(d, $, t) {
            var n = (0, l.sort_out_arguments)(d, $, t), e = n.input, r = n.metadata;
            if (!r)throw new Error("Metadata not passed");
            if (!e)return !1;
            if (!e.country)return !1;
            var i = r.countries[e.country];
            return !((0, o.get_types)(i) && !(0, u.default)(e, r))
        }

        Object.defineProperty($, "__esModule", {value: !0}), $.default = e;
        var r = t(4), l = (n(r), t(14)), u = n(l), o = t(0)
    }, function (d, $, t) {
        d.exports = {default: t(45), __esModule: !0}
    }, function (d, $, t) {
        d.exports = {default: t(44), __esModule: !0}
    }, function (d, $, t) {
        d.exports = {default: t(46), __esModule: !0}
    }, function (d, $, t) {
        "use strict";
        ...
        t(75), t(74), d.exports = t(69)
    }, function (d, $, t) {
        t(71), d.exports = t(1).Object.assign
    }, function (d, $, t) {
        t(72);
        var n = t(1).Object;
        d.exports = function (d, $) {
        ...
        var n = t(21), e = t(66), r = t(65);
        d.exports = function (d) {
            return function ($, t, l) {
                var u, o = n($), i = e(o.length), a = r(l, i);
                if (d && t != t) {
                    for (; i > a;)if (u = o[a++], u != u)return !0
                } else for (; i > a; a++)if ((d || a in o) && o[a] === t)return d || a || 0;
                return !d && -1
            }
        }
    }, function (d, $, t) {
        var n = t(22), e = t(3)("toStringTag"), r = "Arguments" == n(function () {
                return arguments
            }()), l = function (d, $) {
            try {
                return d[$]
        ...
        d.exports = t(2).document && document.documentElement
    }, function (d, $, t) {
        d.exports = !t(5) && !t(17)(function () {
                return 7 != Object.defineProperty(t(23)("div"), "a", {
                        get: function () {
                            return 7
                        }
                    }).a
        ...
        "use strict";
        var n = t(27), e = t(29), r = t(30), l = {};
        t(6)(l, t(3)("iterator"), function () {
            return this
        }), d.exports = function (d, $, t) {
            d.prototype = n(l, {next: e(1, t)}), r(d, $ + " Iterator")
        }
    }, function (d, $) {
        d.exports = function (d, $) {
            return {value: $, done: !!d}
        ...
        "use strict";
        var n = t(28), e = t(59), r = t(62), l = t(32), u = t(25), o = Object.assign;
        d.exports = !o || t(17)(function () {
            var d = {}, $ = {}, t = Symbol(), n = "abcdefghijklmnopqrst";
            return d[t] = 7, n.split("").forEach(function (d) {
                $[d] = d
            }), 7 != o({}, d)[t] || Object.keys(o({}, $)).join("") != n
        }) ? function (d, $) {
            for (var t = l(d), o = arguments.length, i = 1, a = e.f, _ = r.f; o > i;)for (var f, c = u(arguments[i++]), s = a ? n(c).concat(a(c)) : n(c), p = s.length, h = 0; p > h;)_.call(c, f = s[h++]) && (t[f] = c[f]);
            return t
        } : o
    }, function (d, $, t) {
        var n = t(12), e = t(8), r = t(28);
        d.exports = t(5) ? Object.defineProperties : function (d, $) {
            e(d);
        ...
        var n = t(10), e = t(32), r = t(19)("IE_PROTO"), l = Object.prototype;
        ...
        var n = t(10), e = t(21), r = t(49)(!1), l = t(19)("IE_PROTO");
        d.exports = function (d, $) {
            var t, u = e(d), o = 0, i = [];
        ...
        d.exports = function (d) {
            return function ($, t) {
                var r, l, u = String(e($)), o = n(t), i = u.length;
        ...
        var n = t(20), e = Math.max, r = Math.min;
        d.exports = function (d, $) {
            return d = n(d), d < 0 ? e(d + $, 0) : r(d, $)
        }
    }, function (d, $, t) {
        var n = t(20), e = Math.min;
        d.exports = function (d) {
        ...
        var n = t(50), e = t(3)("iterator"), r = t(11);
        d.exports = t(1).getIteratorMethod = function (d) {
            if (void 0 != d)return d[e] || d["@@iterator"] || r[n(d)]
        }
    }, function (d, $, t) {
        var n = t(8), e = t(68);
        d.exports = t(1).getIterator = function (d) {
            var $ = e(d);
        ...
        "use strict";
        var n = t(48), e = t(55), r = t(11), l = t(21);
        d.exports = t(26)(Array, "Array", function (d, $) {
            this._t = l(d), this._i = 0, this._k = $
        }, function () {
            var d = this._t, $ = this._k, t = this._i++;
            return !d || t >= d.length ? (this._t = void 0, e(1)) : "keys" == $ ? e(0, t) : "values" == $ ? e(0, d[t]) : e(0, [t, d[t]])
        }, "values"), r.Arguments = r.Array, n("keys"), n("values"), n("entries")
    }, function (d, $, t) {
        var n = t(9);
        n(n.S + n.F, "Object", {assign: t(57)})
    }, function (d, $, t) {
        var n = t(9);
        n(n.S, "Object", {create: t(27)})
    }, function (d, $, t) {
        var n = t(9);
        n(n.S + n.F * !t(5), "Object", {defineProperty: t(12).f})
    }, function (d, $, t) {
        "use strict";
        var n = t(64)(!0);
        t(26)(String, "String", function (d) {
            this._t = String(d), this._i = 0
        }, function () {
            var d, $ = this._t, t = this._i;
            return t >= $.length ? {value: void 0, done: !0} : (d = n($, t), this._i += d.length, {value: d, done: !1})
        })
    }, function (d, $, t) {
        t(70);
        for (var n = t(2), e = t(6), r = t(11), l = t(3)("toStringTag"), u = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], o = 0; o < 5; o++) {
            var i = u[o], a = n[i], _ = a && a.prototype;
        ...
        function e() {
            ...
            return d.push(x.default), M.default.apply(this, d)
        }

        function r() {
            var d = Array.prototype.slice.call(arguments);
            return d.push(x.default), O.default.apply(this, d)
        }

        function l() {
            var d = Array.prototype.slice.call(arguments);
            return d.push(x.default), E.default.apply(this, d)
        }
        ...
        function o() {
            var d = Array.prototype.slice.call(arguments);
            return d.push(x.default), T.default.apply(this, d)
        }
        ...
        function a(d) {
            S.default.call(this, d, x.default)
        }
        ...
        function f(d) {
            return c(d, x.default)
        }

        function c(d, $) {
            if (!$.countries[d])throw new Error('Unknown country: "' + d + '"');
            return (0, A.get_phone_code)($.countries[d])
        }

        Object.defineProperty($, "__esModule", {value: !0}), $.DIGIT_PLACEHOLDER = $.asYouTypeCustom = $.getNumberTypeCustom = $.isValidNumberCustom = $.formatCustom = $.parseCustom = void 0;
        var s = t(37), p = n(s);
        $.parse = e, $.format = r, $.get_number_type = l, $.getNumberType = u, $.is_valid_number = o, $.isValidNumber = i, $.as_you_type = a, $.asYouType = _;
        var h = t(4);
        ...
        var v = t(14);
        Object.defineProperty($, "getNumberTypeCustom", {
            enumerable: !0, get: function () {
                return n(v).default
            }
        });
        ...
        Object.defineProperty($, "asYouTypeCustom", {
            ...
            enumerable: !0, get: function () {
                return g.DIGIT_PLACEHOLDER
            }
        }), $.getPhoneCode = f, $.getPhoneCodeCustom = c;
        var b = t(34), x = n(b), M = n(h), E = n(v), O = n(m), T = n(y), S = n(g), A = t(0);
        a.prototype = (0, p.default)(S.default.prototype, {}), a.prototype.constructor = a, _.prototype = (0, p.default)(S.default.prototype, {}), _.prototype.constructor = _
    }])
});
