...
{if $loggedin}
    <li menuitemname="Home" class="" id="Primary_Navbar-Home"><a href="{$WEB_ROOT}/clientarea.php">{$LANG.MW_home}</a></li>
    <li menuitemname="Services" class="" id="Primary_Navbar-Services">
        ...
        <ul>
            <li menuitemname="My Services" id="Primary_Navbar-Services-My_Services"><a href="{$WEB_ROOT}/clientarea.php?action=services">{$LANG.MW_myServices}</a></li>
            <li menuitemname="My Licenses" id="Primary_Navbar-Services-My_Licenses"><a href="{$WEB_ROOT}/clientarea.php?action=products&amp;module=licensing">{$LANG.MW_myLicenses}</a></li>
    ...
    <li menuitemname="Domains" class="" id="Primary_Navbar-Domains">
        ...
        <ul>
            ...
            <li menuitemname="Domain Search" id="Primary_Navbar-Domains-Domain_Search"><a href="{$WEB_ROOT}/domainchecker.php">{$LANG.MW_domainSearch}</a></li>
        </ul>
    </li>
    ...
    <li menuitemname="Support" class="" id="Primary_Navbar-Support">
        ...
        <ul>
            ...
            <li menuitemname="Announcements" id="Primary_Navbar-Support-Announcements"><a href="{$WEB_ROOT}/index.php?rp=/announcements">{$LANG.MW_announcements}</a></li>
            <li menuitemname="Knowledgebase" id="Primary_Navbar-Support-Knowledgebase"><a href="{$WEB_ROOT}/index.php?rp=/knowledgebase">{$LANG.MW_knowledgebase}</a></li>
            <li menuitemname="Downloads" id="Primary_Navbar-Support-Downloads"><a href="{$WEB_ROOT}/index.php?rp=/download">{$LANG.MW_downloads}</a></li>
            <li menuitemname="Network Status" id="Primary_Navbar-Support-Network_Status"><a href="{$WEB_ROOT}/serverstatus.php">{$LANG.MW_networkStatus}</a></li>
        </ul>
    </li>
    <li menuitemname="Open Ticket" class="" id="Primary_Navbar-Open_Ticket"><a href="{$WEB_ROOT}/submitticket.php">{$LANG.MW_openTicket}</a></li>
    <li menuitemname="Affiliates" class="" id="Primary_Navbar-Affiliates"><a href="{$WEB_ROOT}/affiliates.php">{$LANG.MW_affiliates}</a></li>
{else}
    ...
    <li menuitemname="Store" class="" id="Primary_Navbar-Store">
        ...
        <ul>
            ...
            <li menuitemname="Transfer a Domain to Us" id="Primary_Navbar-Store-Transfer_a_Domain_to_Us"><a href="{$WEB_ROOT}/cart.php?a=add&amp;domain=transfer">T{$LANG.MW_transferDomainToUs}</a></li>
        </ul>
    </li>
    <li menuitemname="Announcements" class="" id="Primary_Navbar-Announcements"><a href="{$WEB_ROOT}/index.php?rp=/announcements">{$LANG.MW_announcements}</a></li>
    <li menuitemname="Knowledgebase" class="" id="Primary_Navbar-Knowledgebase"><a href="{$WEB_ROOT}/index.php?rp=/knowledgebase">{$LANG.MW_knowledgebase}</a></li>
    <li menuitemname="Network Status" class="" id="Primary_Navbar-Network_Status"><a href="{$WEB_ROOT}/serverstatus.php">{$LANG.MW_networkStatus}</a></li>
    <li menuitemname="Affiliates" class="" id="Primary_Navbar-Affiliates"><a href="{$WEB_ROOT}/affiliates.php">{$LANG.MW_affiliates}</a></li>
    <li menuitemname="Contact Us" class="" id="Primary_Navbar-Contact_Us"><a href="{$WEB_ROOT}/contact.php">{$LANG.MW_contactUs}</a></li>
{/if}