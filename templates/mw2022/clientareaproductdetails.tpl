...
<div class="mw-whm clientareaproductdetails">
    <div class="text-left">
        <h1 class="py-4 mt-5" style="font-weight: 700!important; font-size: 40px!important;">{$LANG.MWproductDetails}</h1><br />
    </div>
                    ...
                    <div class="row col-sm-12 " style="justify-content: center;">
                        ...
                        <div class="col-lg-5 mx-3" style="margin-top: 50px;">
                            <div class=" panel panel-default" style="height:100%;">
                                ...
                                <div class=" py-3">
                                    <h4 style="font-size: 15px; color: #acb0b9;">{$LANG.MWstatus}</h4>
