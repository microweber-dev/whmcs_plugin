...
<form method="post" action="?action=details" role="form">
    ...
    <div class="row panel panel-default mt-5">
        <div style="font-weight: 700!important;" class="px-4 ms-2 py-3">
            <h1> {$LANG.MWpersonalInformation}</h1>
            <br />
        </div>
...
{*            </div>*}
       ...
       <div class="col-md-6 col-12">
           <div class="form-group m-4 ">
               <label for="inputPhone" class="control-label">{$LANG.MWchangePassword}</label><br>
               <button class="whmc-kbtn-2">{$LANG.MWchangePassword}</button>
           </div>
       </div>
