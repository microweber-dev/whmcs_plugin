<div class="mw-whm clientareadomaindetails">
            ...
            <div class="tab-content margin-bottom">
                <div class="tab-pane fade in active" id="tabOverview">
                    ...
                    <div>
                        <div class="info">
                            <div class="col-sm-6">
                                <h4><strong>{$LANG.clientareahostingdomain}:</strong></h4> <a href="http://{$domain}" target="_blank" class="link">{$domain}</a>
                            </div>
                            <div class="col-sm-6">
                ...
                <div class="tab-pane fade" id="tabAutorenew">
                    ...
                    <h2 class="text-center">{$LANG.domainautorenewstatus}: <span
                                class="label label-{if $autorenew}success{else}danger{/if}">{if $autorenew}{$LANG.domainsautorenewenabled}{else}{$LANG.domainsautorenewdisabled}{/if}</span></h2>
                ...
                <div class="tab-pane fade" id="tabNameservers">
                    ...
                    <div class="">
                        <form class="form-horizontal" role="form" method="post" action="{$smarty.server.PHP_SELF}?action=domaindetails#tabNameservers">
                            ...
                            <br/>
                            {for $num=1 to 5}
                                <div class="form-group ns-labale">
                                    <label for="inputNs{$num}" class="col-sm-3 col-md-2 control-label">{$LANG.clientareanameserver} {$num}</label>
                            ...
                            <p class="text-center m-t-40">
                                <input type="submit" class="btn mw-blue" value="{$LANG.changenameservers}"/>
                            </p>
                        </form>
                    </div>
                </div>
                <div class="tab-pane fade" id="tabReglock">
                    ...
                    <h2 class="text-center">{$LANG.domainreglockstatus}: <span
                            ...
                            <div class="col-xs-9 col-md-10">
                                ...
                                <form action="clientarea.php?action=domainaddons" method="post">
                                    ...
                                    {if $addonstatus.emailforwarding}
                                        ...
                                        <a class="btn btn-success" href="clientarea.php?action=domainemailforwarding&domainid={$domainid}">{$LANG.manage}</a>
                                        <input type="submit" value="{$LANG.disable}" class="btn btn-danger"/>
                                    {else}
