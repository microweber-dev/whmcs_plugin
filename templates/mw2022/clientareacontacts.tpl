<div class="mw-whm clientareacontact">


    <div class="header-lined text-center">
        <h1>Contacts / Sub-accounts</h1>
        <br/>
    </div>
    ...
    {if $contactid}
        ...
        <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts&id={$contactid}">
            ...
            <div class="form-group text-center">
                ...
                <input class="cbtn cbtn-alt" type="button" value="{$LANG.clientareadeletecontact}" onclick="deleteContact('{$LANG.clientareadeletecontactareyousure}', {$contactid})"/>
            </div>
