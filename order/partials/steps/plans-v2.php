        ...
        <?php if ($key == 0): ?>
            ...
            <section class="section-15 inverse">
                <div class="container align-self-center">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="img-holder-bg d-flex align-items-center justify-content-center" style="background-image: url('partials/steps/plans-v2/img/plans-1.png');">
                                <div class="text-left">
                                    ...
                                    <div class="m-t-50 support-by">
                                        <p>С подкрепата на: &nbsp; <a href="partials/steps/plans-v2/img/neterra_logo.png" alt=""></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="info-holder text-left ">
                                <div class="align-self-center">
                                    <img src="partials/steps/plans-v2/img/plans-up-1.png"/><br/><br/>
                                    <div class="box">
                                        <div class="thing"><img src="partials/steps/plans-v2/img/plan-1.svg"/></div>
                                        <div class="price text-<?php echo $planColor; ?>">
                                            <span class="sum">0 лв.</span> <span class="per"> / на месец</span>
                                        </div>
                                        <br/>
                                        <img src="partials/steps/plans-v2/img/neterra_logo.png"/>
                                        <br/>
                                        <br/>
        ...
        <?php elseif ($key == 1): ?>
            ...
            <section class="section-15 inverse">
                <div class="container align-self-center">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="img-holder-bg d-flex align-items-center justify-content-center" style="background-image: url('partials/steps/plans-v2/img/plans-2.png');">
                                <div class="text-left">
                                    <h2 class="text-<?php echo $planColor; ?>"><?php print $plan['name'] ?></h2>
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="info-holder text-left ">
                                <div class="align-self-center">
                                    <img src="partials/steps/plans-v2/img/plans-up-2.png"/><br/><br/>
                                    <div class="box">
                                        <div class="thing"><img src="partials/steps/plans-v2/img/plan-2.svg"/></div>
                                        <div class="price text-default">
                                            <span class="sum">9,90 лв.</span> <span class="per"> / на месец</span>
                                        </div>
        ...
        <?php elseif ($key == 2): ?>
            ...
            <section class="section-15 inverse">
                <div class="container align-self-center">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="img-holder-bg d-flex align-items-center justify-content-center" style="background-image: url('partials/steps/plans-v2/img/plans-3.png');">
                                <div class="text-left">
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="info-holder text-left ">
                                <div class="align-self-center">
                                    <img src="partials/steps/plans-v2/img/plans-up-3.png"/><br/><br/>
                                    <div class="box">
                                        <div class="thing"><img src="partials/steps/plans-v2/img/plan-3.svg"/></div>
                                        <div class="price text-<?php echo $planColor; ?>">
                                            <span class="sum">113 лв.</span> <span class="per">/ на месец</span>
                                        </div>
                                        ...
                                        <a href="https://client.cloudware.bg/index.php?/cart/dedicated-servers/" target="_blank"><img src="partials/steps/plans-v2/img/cloudware.png"/></a>
                                        <br/>
                                        <br/>
                                        <br/>
