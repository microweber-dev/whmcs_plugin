    ...
    <?php foreach ($plans as $key => $plan): ?>
        ...
        <section class="section-15 inverse">
            <div class="container align-self-center">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="img-holder-bg d-flex align-items-center justify-content-center" style="background-image: url('<?php print site_url(); ?>/modules/addons/microweber_addon/order/templates/<?php echo $template_config['folder_name']; ?>/plans/assets/img/plans-<?php print $planKey; ?>.png');">
                            <div class="text-left">
                                <h2 class="text-<?php echo $planColor; ?>"><?php print $plan['name'] ?>!</h2>
                                <?php if ($key == 0): ?>
                                    <h2>1 GB <span class="text-default">storage</span> and <br>unlimited<br> bandwidth.</h2>
                                <?php elseif ($key == 1): ?>
                                    <h2>10 GB <span class="text-default">storage</span> and <br>unlimited<br> bandwidth.</h2>
                                <?php elseif ($key == 2): ?>
                                    <h2>15 GB <span class="text-default">storage</span> and <br>unlimited<br> bandwidth.</h2>
                                <?php endif; ?>

                                <div class="m-t-50 support-by">
                                    <p>Trust on&nbsp;<img src="<?php print $CONFIG['LogoURL']; ?>" alt="" style="max-width: 140px;"/>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
                        <div class="info-holder text-left ">
                            <div class="align-self-center">
                                <img src="<?php print site_url(); ?>/modules/addons/microweber_addon/order/templates/<?php echo $template_config['folder_name']; ?>/plans/assets/img/plans-up-<?php print $planKey; ?>.png"/><br/><br/>
                                <div class="box">
                                    <div class="thing"><img src="<?php print site_url(); ?>/modules/addons/microweber_addon/order/templates/<?php echo $template_config['folder_name']; ?>/plans/assets/img/plan-<?php print $planKey; ?>.svg"/></div>
