...
<head>
    ...
    <link href="<?php echo $CONFIG['SystemURL']; ?>/modules/addons/microweber_addon/order/templates/microweber.bg/plans/assets/css/main.css" rel="stylesheet"/>
    <link href="<?php echo $CONFIG['SystemURL']; ?>/modules/addons/microweber_addon/order/templates/microweber.bg/plans/assets/css/custom.css" rel="stylesheet"/>
