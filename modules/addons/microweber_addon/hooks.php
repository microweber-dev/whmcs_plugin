    ...
    if ($output['admin']) {
		...
		<div class="panel panel-default whmc-2022-panel " id="mwPanelConfigurableOptionsPanel">
			   <div class="panel-heading">
				   <h3 class="panel-title" style="font-size: 25px!important;">Website</h3>
			   </div>
			   <div class="panel-body" style="padding-top: 0;">
								   <div class="row">
						   <div class="col-sm-12 hosting-information-titles left-padding-domain">
							   <p class="pb-2" style="font-size: 20px;">Domain</p>
						   ...
						   <a class="whmc-kbtn" href="' . $output['admin'] . '" target="_blank"><i class="fa fa-user pe-2"></i> Login as Admin</a>
						   <a class="whmc-kbtn-2" href="' . $output['live_edit'] . '" target="_blank"><i class="fa fa-pencil pe-2"></i>Go to website</a>
